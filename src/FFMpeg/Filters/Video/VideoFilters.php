...
{
    /**
     * @param \FFMpeg\Media\Video $media
     */
    ...
    {
        $this->media->addFilter(new PrepareForWebFilter());

        return $this;
    }

    /**
     * Prepend a movie to current video
     *
     * @param string $videoPath
     *
     * @return \FFMpeg\Filters\Video\VideoFilters
     */
    public function concat($videoPath)
    {
        $this->media->addFilter(new ConcatFilter($videoPath));
